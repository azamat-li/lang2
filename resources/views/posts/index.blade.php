					...
					<li class="mt-6">
						...
						<div class="px-3 pt-1 pb-3">
							...
							<div class="text-base md:text-sm text-gray-500 pb-2">
								Ярлычки: <a href="#" class="text-base md:text-sm text-green-500 no-underline hover:underline">Link</a>  <a href="#" class="text-base md:text-sm text-green-500 no-underline hover:underline">Link</a>
							</div>
						</div>
					</li>
				@empty 
