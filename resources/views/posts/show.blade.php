...
&lt;/header&gt;
		...
		<!--Comments-->
		<div class="px-4 pt-10 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-2xl md:px-24 lg:px-8 lg:py-20">
			<div class="grid gap-10 row-gap-8 lg:grid-cols-2">
				<div class="flex flex-col space-y-8 lg:col-span-3">
					...
					<div>
						...
						<p class="mb-4 text-base text-gray-700 md:text-lg">
 							{{ $post->comments()->first()->message }}
						</p>
						<div class="flex items-center">
							<a href="/" aria-label="Author" class="mr-3">
							</a>
							<div>
								<a href="/" aria-label="Author" class="font-semibold text-gray-800 transition-colors duration-200 hover:text-deep-purple-accent-400">{{ $comment->name }}</a>
								<p class="text-sm font-medium leading-4 text-gray-600">posted</p>
							</div>
						</div>
					</div>
